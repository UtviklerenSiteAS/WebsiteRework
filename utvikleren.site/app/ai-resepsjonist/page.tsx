                ...
                <div className="max-w-[1200px] mx-auto">
                    ...
                    <div className="border-b border-white/20 pb-20 mb-20">
                        <motion.span
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            className="block text-purple-400 font-mono text-sm tracking-widest uppercase mb-6"
                        >
                            AI Automatisering
                        </motion.span>
                        <motion.h1
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-12">
                        ...
                        <Link
                            href="/priser"
                            className="group inline-flex items-center gap-3 text-2xl font-medium border-b border-white pb-1 hover:text-purple-400 hover:border-purple-400 transition-colors"
                        >
                            Se Priser og Pakker
